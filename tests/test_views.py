...
class TestCurrencyResource:
    ...
    def test_currency_get_notexist_id(self,client,create_user,login):
        create_currency(client,'AUD',1.45)
        get_response = client.get('/v1/currencies/2',
        headers = {"Content-Type": "application/json",
        "Authorization": f"Bearer {login['auth_token']}"})
    ...
    def test_currency_update(self,client,create_user,login):
        create_currency(client,'AUD',1.45)
        patch_response = client.patch('/v1/currencies/1',
        headers = {'Content-Type': 'application/json'},
        data = json.dumps({
        'abbreviation': 'Aud',
...
class TestCurrencyListResource:
    ...
    def test_currency_get_without_id(self,client,create_user,login):
        ...
        assert len(get_first_page_response_data['currencies']) == 2
        assert get_first_page_response_data['currencies'][0]['abbreviation'] == 'AUD'
        assert get_first_page_response_data['currencies'][0]['usd_to_local_exchange_rate'] == 1.45
        assert get_first_page_response_data['currencies'][1]['abbreviation'] == 'CHF'
        assert get_first_page_response_data['currencies'][1]['usd_to_local_exchange_rate'] == 0.92
