...
from tests.fixtures.currency_conversion_html import mock_currency_conversion_rates_html, mock_boto3_s3
from scripts.extract_currency_conversion_rates import extract_currency_conversion_rates

def test_extract_currency_conversion_rates(requests_mock, mocker, mock_boto3_s3, mock_currency_conversion_rates_html):
    ...
    {"OMR": "0.38"}, {"PLN": "4.34"}, {"QAR": "3.64"}, {"RON": "4.65"}, {"RSD": "109.81"}, {"RUB": "96.59"}, {"SAR": "3.75"}, {"SEK": "11.16"}, {"SGD": "1.36"}, 
    {"THB": "35.78"}, {"TRY": "27.01"}, {"TWD": "32.03"}, {"UAH": "36.86"}, {"UYU": "38.07"}, {"PYG": "7,258.93"}])
